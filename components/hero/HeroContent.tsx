  ...
  return (
    <div className="w-full max-w-[1400px] mx-auto space-y-8">
      ...
      <motion.div
        ...
        className="relative"
      >
        <p className="text-lg sm:text-xl md:text-2xl lg:text-3xl font-medium text-white/90 text-center">
      ...
      <div className="text-center">
        <div className="relative inline-block text-[32px] sm:text-[48px] md:text-[72px] lg:text-[120px] font-bold leading-none">
      ...
      <motion.div
        ...
        className="relative"
      >
        <p className="text-base sm:text-lg md:text-xl lg:text-2xl font-medium text-white/90 max-w-4xl mx-auto text-center leading-relaxed px-4">
